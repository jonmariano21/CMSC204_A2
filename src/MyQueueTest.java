...
public class MyQueueTest {
	...
	public void testIsEmpty() {
		try {
			...
			assertTrue("This should not have caused an QueueUnderflowException", false);
		}
		catch (Exception e){
	...
	public void testSize() {
		try {
			...
			assertTrue("This should not have caused an QueueOverflowException", false);
		}
		catch (Exception e){
			assertTrue("This should not have caused an Exception", false);
		}
